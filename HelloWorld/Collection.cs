...
public class Collections
{
    ...
    //Hashset Collections
    //There is no particular order to the elements it is not zero-based index (meaning you can't get specific elements of LINQ)
    ...
    //Keys nee to be unique to be able to locat information
    ...
    public void CollectionsMain()
    {
        ...
        // //Allows us to set what to store in certain postitions
        ...
        //Foreach will iterate through all of the elements of the array
        //Syntax: ((dattype) (nameOfVariable) in (nameOfArray))
