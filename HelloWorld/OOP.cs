...
public class Animal : IAnimal
{
    ...
    //Base class method needs to be virtual keyword(non-access modifier)
...
//Inheritance is donated by ":" syntax, the class after the color is the one it is trying to inherit from
...
public class Dog : Animal
{
    ...
    //Usually used to ass on pre-existing method from the base class
...
//This is an example of hiarchical inheritance
